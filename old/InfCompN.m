function H = InfCompN (D, Ntu, N, Nt, Deltax, Deltat,fx,ft, S, inv, k,f_number,c, Nn)
...
H=InfG2( D, Ntu, N, Nt, Deltax, Deltat,fx,ft,S,R,f,Deltaphi, c, Nn, 1,6)



%%H/(4*pi/Deltaphi/Deltaphi/(3*sqrt(3)/8))
%H=H/(inv+6*c*4*pi*Ntu/Deltaphi/Deltaphi/(2*sqrt(3)/3));
